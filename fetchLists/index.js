...
const fetchTokens = async () => {
  try {
    ...
    const tokenFileURL =
      'https://cdn.jsdelivr.net/gh/smilofoundation/ethereum-lists@master/dist/tokens/';
...
const fetchDarkList = async () => {
  try {
    ...
    const darkList = await fetch(
      'https://cdn.jsdelivr.net/gh/smilofoundation/ethereum-lists@master/src/addresses/addresses-darklist.json'
    )
      .then(res => res.json())
      .catch(console.log);
    const jsonToStore = {
...
const fetchContracts = async () => {
  try {
    ...
    const contractFileURL =
      'https://cdn.jsdelivr.net/gh/smilofoundation/ethereum-lists@master/dist/contracts/';
