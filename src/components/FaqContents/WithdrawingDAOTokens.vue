<template>
  <div>
    ...
    <ol>
      <li>
        Have XSM in the account that has DAO tokens in it so you can collect the
        refund.
      </li>
      <li>
        Go to
      ...
      <li>
        Make sure the XSM node in the top right corner is selected (Try out
    ...
    <p>
      ...
      bunch of XSM delivered to you :-) Remember that a lot of people worked
    ...
    <ol>
      <li>Have XSM in the account that can collect the refund.</li>
      <li>
        Go to
        <a
          href="https://www.myetherwallet.com/#send-transaction"
    ...
    <p>
      <strong>
        Note: You will need minimum 0.01 XSM and 0.01 ETC in order to cover the
